...
class ValidateORM {
    ...
    public static function notNull($cnpjing) {

        if ($cnpjing === "" || $cnpjing === null) {
            return false;
        }
    ...
    public static function size($cnpjing, $size) {

        if (strlen($cnpjing) != $size) {
            return false;
        }
     ...
     * @return boolean 
     */
    public static function maxSize($cnpjing, $size) {
        if (strlen($cnpjing) > $size) {
            return false;
        }
     ...
     * @return boolean 
     */
    public static function minSize($cnpjing, $size) {
        if (strlen($cnpjing) < $size) {
            return false;
        }
        return true;
